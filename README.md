...
- [co-author.nvim](https://github.com/2kabhishek/co-author.nvim) — Git commit co-authors automation tool
- [exercism.nvim](https://github.com/2kabhishek/exercism.nvim) — Exercism.org coding exercises client
- [markit.nvim](https://github.com/2kabhishek/markit.nvim) — Interactive, rich visual Neovim marks manager
- [nerdy.nvim](https://github.com/2kabhishek/nerdy.nvim) — Search and insert Nerd Font glyphs directly within Neovim
- [octohub.nvim](https://github.com/2kabhishek/octohub.nvim) — GitHub repository explorer and manager
- [pickme.nvim](https://github.com/2kabhishek/pickme.nvim) — Unified interface wrapper for Telescope, FZF-Lua, and Snacks pickers
- [seeker.nvim](https://github.com/2kabhishek/seeker.nvim) — Progressive file and grep selector
- [tdo.nvim](https://github.com/2kabhishek/tdo.nvim) — Minimalist note-taking and todo manager
- [template.nvim](https://github.com/2kabhishek/template.nvim) — Boilerplate starter template for Neovim plugins
- [termim.nvim](https://github.com/2kabhishek/termim.nvim) — Floating and split terminal manager
- [utils.nvim](https://github.com/2kabhishek/utils.nvim) — Shared Lua utilities for Neovim plugins
