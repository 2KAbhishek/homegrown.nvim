...
function M.setup()
    vim.keymap.set('n', '<C-h>', function()
        tmux_navigate('h')
    end, { silent = true, desc = 'Tmux Navigate Left' })
    vim.keymap.set('n', '<C-j>', function()
        tmux_navigate('j')
    end, { silent = true, desc = 'Tmux Navigate Down' })
    vim.keymap.set('n', '<C-k>', function()
        tmux_navigate('k')
    end, { silent = true, desc = 'Tmux Navigate Up' })
    vim.keymap.set('n', '<C-l>', function()
        tmux_navigate('l')
    end, { silent = true, desc = 'Tmux Navigate Right' })
end
